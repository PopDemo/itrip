...
<div id="main">
        ...
        <form name=alipayment action='${pageContext.request.contextPath}/api/pay1' method="post">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                       ...
                       <input type="text" name="WIDsubject" value="${hotelName}">
                       <input type="text" name="WIDtotal_amount" value="${payAmount}">
